...
class _TabCancelState extends State<TabCancel> {
  ...
  void initState() {
    ...
    super.initState();
    context.read<OrderBloc>().add(EventLoadingOrderToCancel());
  }
    ...
    return BlocListener<OrderBloc, OrderState>(
      ...
      child: BlocBuilder<OrderBloc, OrderState>(builder: (context, state) {
        ...
        return Container(
          ...
          child: ListView(
            children: [
              state.ordersToCancel.length > 0
                  ? ListView.separated(
                      physics: const NeverScrollableScrollPhysics(),
                      padding:
                          EdgeInsets.symmetric(vertical: 8.h, horizontal: 8.w),
                      itemCount: state.ordersToCancel.length,
                            ...
                            child: Column(
                              children: [
                                OrderedItem(
                                  ...
                                  order: state.ordersToCancel[index],
                                ),
                                Row(
