...
class TabCompleted extends StatefulWidget {
  ...
  @override
  State<TabCompleted> createState() => _TabCompletedState();
}
...
class _TabCompletedState extends State<TabCompleted> {
  ...
  void initState() {
    ...
    super.initState();
    context.read<OrderBloc>().add(EventLoadingOrderToReceive());
  }
    ...
    return BlocListener<OrderBloc, OrderState>(
      ...
      child: BlocBuilder<OrderBloc, OrderState>(builder: (context, state) {
        ...
        return Container(
          ...
          child: ListView(
            children: [
              state.ordersToReceive.length > 0
                  ? ListView.separated(
                      physics: const NeverScrollableScrollPhysics(),
                      padding:
                          EdgeInsets.symmetric(vertical: 8.h, horizontal: 8.w),
                      itemCount: state.ordersToReceive.length,
                            ...
                            child: Column(
                              children: [
                                OrderedItem(
                                  ...
                                  order: state.ordersToReceive[index],
                                ),
                                Row(
